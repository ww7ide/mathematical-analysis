...
\begin{remark}
    \begin{enumerate}
        ...
        Dedekind 的研究表明, 为了在公理化集合论的框架内证明自然数的存在性, 还需要无穷公理: \textsl{存在归纳集.} 这里, \textsl{称集合 \(N\) 是归纳集, 若 \(\varnothing \in N\) 且对于任意 \(n \in N\) 都有 \(n \cup \{n\} \in N\).} 考虑集合
        \[
        ...
        \]
        最后, 令 \(0 \coloneqq \varnothing\). 可以证明, \(\N\) 本身是归纳集且 \((\N, 0, \nu)\) 满足 Peano 公理. 因此, \((\N, 0, \nu)\) 是一个自然数模型.
