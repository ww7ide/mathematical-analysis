...
\begin{example}\label{ex:plus-on-function-spaces}
...
\begin{example}\label{ex:algebras}
    \begin{enumerate}
        ...
        \end{enumerate}
        则称 $B$ 是 $A$ 的子代数.
        \item 设 $X$ 是非空集合. 则 $K^X$ 在定义例 \ref{ex:rings}.2 和例 \ref{ex:vector-spaces}.5 的运算后是具有单位元的交换 $K$-代数.
    \end{enumerate}
\end{example}
