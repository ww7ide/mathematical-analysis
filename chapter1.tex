...
\begin{axiom}[自然数]\label{ax:natural-numbers}
    ...
    \[
        \nu \colon \N \to \N^\ast \coloneqq \N \!\setminus\! \{e\}\ ,\quad n \mapsto \nu(n)\ .
    \]
    若
...
\begin{axiom}[域]
    ...
    \begin{enumerate}[label={\((\mathrm F_{\arabic*})\)}]
        \item \((K, +, \times)\) 是含幺的交换环.
        \item \(\bigl(K \!\setminus\! \{0\}, \times\bigr)\) 是 Abel 群.
    \end{enumerate}
    则称 \((K, +, \times)\) 是域.
\end{axiom}
...
\begin{proposition}\label{prop:irQ-density-in-R}
    对于任意 \(a, b \in \R\) 使得 \(a < b\), 存在 \(\xi \in \R \!\setminus\! \Q\) 使得 \(a < \xi < b\).
\end{proposition}
