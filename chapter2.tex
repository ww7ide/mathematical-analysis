...
\begin{example}
    \begin{enumerate}
        ...
        \]
        其中 $x \coloneqq (x_1, \dots, x_m) \in X$ 且 $y \coloneqq (y_1, \dots, y_m) \in X$ 是 $X$ 上的度量, 称为积度量. 进一步, 称 $(X,d)$ 是 $(X_j, d_j),\ 1 \leq j \leq m$ 的积空间. 可以验证, 对于任意 $a \coloneqq (a_1, \ldots, a_m) \in X$ 以及 $r > 0$, 都有
        \[
...
\begin{definition}[邻域]
    设 $X$ 是度量空间, $U \subseteq X$, $a \in X$. 若存在 $r > 0$ 使得 $\oball(a,r) \subseteq U$, 则称 $U$ 是 $a$ 的邻域. 进一步, 将 $a$ 的邻域的全体记作
    \[
