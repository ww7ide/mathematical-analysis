...
\begin{proof}
    只用证
    $$
    \biggl|\frac{1}{n} \sum_{j=1}^n x_j - a\biggr| \to 0\ .
    $$
    注意到
    $$
    0 \leq \biggl|\frac{1}{n} \sum_{j=1}^n x_j - a\biggr| = \biggl|\frac{1}{n} \sum_{j=1}^n (x_j - a)\biggr| \leq \frac{1}{n} \sum_{j=1}^n |x_j - a|\ ,
    $$
